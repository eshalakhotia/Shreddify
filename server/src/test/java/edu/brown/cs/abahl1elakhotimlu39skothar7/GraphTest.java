...
public class GraphTest {
  ...
  public void setUp() {
    ...
    Exercise bicycleCrunches = new Exercise("bicycleCrunches40", "40 bicycle crunches", 60, 60, 40, targetAreas1, new HashSet<>());
    Exercise jumpingJacks = new Exercise("jumpingJacks100", "100 jumping jacks", 88, 300, 100, targetAreas2, new HashSet<>());
    Exercise wallSit = new Exercise("wallSit60", "60 sec wall sit", 85, 60, 1, targetAreas3, equipment1);
    Exercise toeTouches = new Exercise("toeTouches60", "60 sec toe touches", 32, 60, 1, targetAreas4, new HashSet<>());
    Exercise pushUps = new Exercise("pushUps20", "20 push ups", 46, 70, 20, targetAreas5, new HashSet<>());
    Exercise russianTwists = new Exercise("russianTwists40", "40 push ups", 56, 70, 40, targetAreas1, equipment2);
